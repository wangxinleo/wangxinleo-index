...
![图片无法查看请移步顶部访问 国内备用仓库地址](/assets/img/wx-push/run-img.jpg)


![图片无法查看请移步顶部访问 国内备用仓库地址)](/assets/img/wx-push/run-img-2.jpg)
...
![图片无法查看请移步顶部访问 国内备用仓库地址](/assets/img/wx-push/wx-test-id.png)

- 扫描测试号二维码关注测试号, 扫描之后, 右边就会出现相应的已关注人员id, 记下备用

![图片无法查看请移步顶部访问 国内备用仓库地址](/assets/img/wx-push/wx-test-follow.png)
...
![图片无法查看请移步顶部访问 国内备用仓库地址](/assets/img/wx-push/wx-test-tmp.png)
...
![github-fork](/assets/img/wx-push/github-fork.png)

- 修改相应配置

![图片无法查看请移步顶部访问 国内备用仓库地址](/assets/img/wx-push/github-into-config.png)

![图片无法查看请移步顶部访问 国内备用仓库地址](/assets/img/wx-push/github-into-config-2.png)

![图片无法查看请移步顶部访问 国内备用仓库地址](/assets/img/wx-push/github-into-config-3.png)


- 按需填入相应配置后保存

![图片无法查看请移步顶部访问 国内备用仓库地址](/assets/img/wx-push/edit-config.png)

![图片无法查看请移步顶部访问 国内备用仓库地址](/assets/img/wx-push/edit-config-commit.png)

![图片无法查看请移步顶部访问 国内备用仓库地址](/assets/img/wx-push/edit-config-eg.png)

### 1.4. 第四步：启用workflow自动任务，定时执行

- 启用action脚本

![图片无法查看请移步顶部访问 国内备用仓库地址](/assets/img/wx-push/action.png)

![图片无法查看请移步顶部访问 国内备用仓库地址](/assets/img/wx-push/action-comit.png)

![图片无法查看请移步顶部访问 国内备用仓库地址](/assets/img/wx-push/action-comit-2.png)
...
![图片无法查看请移步顶部访问 国内备用仓库地址](/assets/img/wx-push/action-test.png)

- 查看执行结果

![图片无法查看请移步顶部访问 国内备用仓库地址](/assets/img/wx-push/action-test-2.png)


![图片无法查看请移步顶部访问 国内备用仓库地址](/assets/img/wx-push/action-test-3.png)


![图片无法查看请移步顶部访问 国内备用仓库地址](/assets/img/wx-push/action-test-4.png)
...
![图片无法查看请移步顶部访问 国内备用仓库地址](/assets/img/wx-push/self-keyword.png)

但是有以下情况需要注意，不要占用表中已有的关键字，会发生不可预料的状况噢！

![图片无法查看请移步顶部访问 国内备用仓库地址](/assets/img/wx-push/self-keyword-2.png)
...
![图片无法查看请移步顶部访问 国内备用仓库地址](/assets/img/wx-push/action-cron.png)
...
![图片无法查看请移步顶部访问 国内备用仓库地址](/assets/img/wx-push/pr-1.png)
...
![图片无法查看请移步顶部访问 国内备用仓库地址](/assets/img/wx-push/wechat-public-account-push.png)
...
![图片无法查看请移步顶部访问 国内备用仓库地址](/assets/img/wx-push/dis.png)

![图片无法查看请移步顶部访问 国内备用仓库地址](/assets/img/wx-push/dis-2.png)
